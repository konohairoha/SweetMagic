...
public class PotRecipePlugin implements IPotRecipePlugin {
	...
	public void registerPotRecipe(PotRecipes recipe) {
		...
		recipe.addRecipe(new PotRecipes(
			...
			new Object[] { "cropSweetpotato", new OreItems("bucketWater", 2), "dustSalt", new OreItems("dustSugar", 2)},
		...
		// 栗ご飯
		recipe.addRecipe(new PotRecipes(
			new OreItems("cropChestnut", 8),
			new Object[] { new OreItems("foodRice", 4), new OreItems("dustSalt", 2), new OreItems("bucketWater", 4), new OreItems("cropSeaweed", 4) },
		...
		// フィッシュアンドチップス
		recipe.addRecipe(new PotRecipes(
			new ItemStack(Items.FISH, 4),
			new Object[] { new ItemStack(ItemInit.fried_potato, 2), new OreItems("dustFlour", 3), "dustSalt", new OreItems("foodOil", 4) },
			new ItemStack[] { new ItemStack(ItemInit.fish_and_chips, 4) }
		));
	}
}
