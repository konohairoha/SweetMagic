...
public class PedalRecipes {
    ...
    public PedalRecipes(Object hand , Object[] inputs ,Object[] outputs) {
    	this(hand, inputs, outputs, false, 0);
    }

    public PedalRecipes(Object hand , Object[] inputs ,Object[] outputs, int needMF) {
    	this(hand, inputs, outputs, false, needMF);
    }
    public PedalRecipes(Object hand , Object[] inputs ,Object[] outputs, boolean keepTag) {
    	this(hand, inputs, outputs, keepTag, 0);
    }

    public PedalRecipes(Object hand , Object[] inputs ,Object[] outputs, boolean keepTag, int needMF) {
