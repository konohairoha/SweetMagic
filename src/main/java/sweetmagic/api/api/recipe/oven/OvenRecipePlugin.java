...
public class OvenRecipePlugin implements IOvenRecipePlugin {
	...
	public void registerOvenRecipe(OvenRecipes recipe) {
		...
		//チョコマフィン
		recipe.addRecipe(new OvenRecipes(
			new OreItems("foodCocoapowder", 4),
		...
		recipe.addRecipe(new OvenRecipes(
			...
			new Object[] { new OreItems("foodVanilla", 2), new OreItems("dustFlour", 2), new OreItems("egg", 2), new OreItems("dustSugar", 2), "bucketMilk", "foodButter" },
		...
		recipe.addRecipe(new OvenRecipes(
			...
			new Object[] { new OreItems("foodChocolatebar", 4), new OreItems("dustSugar", 2), "bucketMilk", "foodButter","egg" },
		...
		recipe.addRecipe(new OvenRecipes(
			...
			new Object[] { new ItemStack(ItemInit.azuki_seed, 4), new OreItems("foodButter", 4), new OreItems("dustSugar", 2) },
			new ItemStack[] { new ItemStack(ItemInit.ogura_toast, 3) }
		));
		...
		recipe.addRecipe(new OvenRecipes(
			new OreItems("bread", 2),
			new Object[] { new OreItems("cropStrawberry", 4), new OreItems("dustSugar", 2) },
			new ItemStack[] { new ItemStack(ItemInit.jam_toast, 3) }
		));
		...
		recipe.addRecipe(new OvenRecipes(
			"foodDough",
			new Object[] { new OreItems("foodChocolatebar", 2), new OreItems("foodCream", 2), new OreItems("foodCocoapowder", 4) },
		...
		// スイートポテト
		recipe.addRecipe(new OvenRecipes(
			new OreItems("cropSweetpotato", 4),
		...
		recipe.addRecipe(new OvenRecipes(
			...
			new Object[] { new OreItems("foodVanilla", 2), new OreItems("dustSugar", 2) },
		...
		recipe.addRecipe(new OvenRecipes(
			...
			new Object[] { new OreItems("dustFlour", 3), new OreItems("egg", 2), "foodButter", "dustSugar", "foodOil", "foodVanilla" },
			new ItemStack[] { new ItemStack(ItemInit.german_tree_cake, 4) }
		));

		// タルトタタン
		recipe.addRecipe(new OvenRecipes(
			new OreItems("cropApple", 12),
		...
		// ガトーショコラ
		recipe.addRecipe(new OvenRecipes(
			new OreItems("foodCocoapowder", 8),
			new Object[] { new OreItems("foodChocolatebar", 2), new OreItems("foodCream", 2), new OreItems("dustFlour", 4), new OreItems("egg", 2), new OreItems("foodButter", 2), "dustSalt" },
		...
		recipe.addRecipe(new OvenRecipes(
			"foodLiquor",
			new Object[] { new OreItems("dustFlour", 4), "egg", new OreItems("foodButter", 2), new OreItems("bucketMilk", 2), new OreItems("dustSugar", 2), "foodVanilla" },
		...
		recipe.addRecipe(new OvenRecipes(
			new OreItems("foodCocoapowder", 4),
			new Object[] { new OreItems("egg", 2), new OreItems("dustSugar", 2), "dyeRed", "dyeLime" },
			new ItemStack[] { new ItemStack(ItemInit.macaroon, 5) }
		));

		// カップケーキ
		recipe.addRecipe(new OvenRecipes(
			new OreItems("foodOil", 1),
			new Object[] { new OreItems("egg", 2), new OreItems("dustFlour", 4), new OreItems("dustSugar", 2), "bucketMilk", "foodButter" },
			new ItemStack[] { new ItemStack(ItemInit.cup_cake, 6) }
		));

		// アイシングクッキー
		recipe.addRecipe(new OvenRecipes(
			"dyeRed",
			new Object[] { new OreItems("dustFlour", 3), new OreItems("egg", 2), new OreItems("dustSugar", 3), "foodButter", "dyeLightBlue" },
			new ItemStack[] { new ItemStack(ItemInit.icing_cookies, 7) }
		));

		// ココナッツクッキー
		recipe.addRecipe(new OvenRecipes(
			new OreItems("cropCoconut", 3),
			new Object[] { new OreItems("dustFlour", 3), new OreItems("egg", 2), new OreItems("dustSugar", 3), "foodButter", new OreItems("foodVanilla", 3) },
			new ItemStack[] { new ItemStack(ItemInit.coconuts_cookie, 6) }
		));
	}
}
