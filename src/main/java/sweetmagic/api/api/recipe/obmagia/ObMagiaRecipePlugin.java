...
public class ObMagiaRecipePlugin implements IObMagiaRecipePlugin {
	...
	public void registerObMagiaRecipe(ObMagiaRecipes recipe) {
		...
		// 地震魔法
		recipe.addRecipe(new ObMagiaRecipes(
			new ItemStack(ItemInit.magic_hugerock_fall),
			new Object[] { new OreItems("stone", 64), new ItemStack(ItemInit.sugarbell, 32), new ItemStack(ItemInit.mystical_page, 3) },
			new ItemStack[] { new ItemStack(ItemInit.magic_earthquake) }
		));
		...
		// 回避滑空魔法
		recipe.addRecipe(new ObMagiaRecipes(
			new ItemStack(ItemInit.magic_avoid_3),
			new ItemStack[] { new ItemStack(ItemInit.tiny_feather, 24), new ItemStack(ItemInit.cosmic_crystal_shard, 4), new ItemStack(ItemInit.mystical_page, 4) },
			new ItemStack[] { new ItemStack(ItemInit.magic_avoid_tornado) }
		));
		...
		// 因果律予測魔法
		recipe.addRecipe(new ObMagiaRecipes(
			new ItemStack(ItemInit.magic_futurevision),
			new ItemStack[] { new ItemStack(ItemInit.cosmic_crystal_shard, 4), new ItemStack(ItemInit.pure_crystal, 4), new ItemStack(ItemInit.magic_book_cosmic),
					new ItemStack(ItemInit.mystical_page, 4) },
			new ItemStack[] { new ItemStack(ItemInit.magic_causality_prediction) }
		));
		...
		// 弾ベクトル無効化魔法
		recipe.addRecipe(new ObMagiaRecipes(
			new ItemStack(ItemInit.magic_vector_halten),
			new ItemStack[] { new ItemStack(ItemInit.pure_crystal), new ItemStack(ItemInit.grav_powder, 16),
					new ItemStack(ItemInit.clero_petal, 24), new ItemStack(ItemInit.mysterious_page, 4) },
			new ItemStack[] { new ItemStack(ItemInit.magic_vector_field) }
		));
		...
		recipe.addRecipe(new ObMagiaRecipes(
			...
			new ItemStack[] { new ItemStack(ItemInit.cosmic_crystal_shard, 4), new ItemStack(ItemInit.stray_soul, 24), new ItemStack(ItemInit.mystical_page, 3) },
			new ItemStack[] { new ItemStack(ItemInit.magic_blackcat) }
		));
		...
		// オシリス魔法
		recipe.addRecipe(new ObMagiaRecipes(
			new ItemStack(ItemInit.magic_thunder),
			new ItemStack[] { new ItemStack(ItemInit.cosmic_crystal_shard, 4), new ItemStack(ItemInit.electronic_orb, 64), new ItemStack(ItemInit.mysterious_page, 8), new ItemStack(ItemInit.mystical_page, 3) },
			new ItemStack[] { new ItemStack(ItemInit.magic_thunderforce) }
		));
		...
		// 範囲超猛毒魔法
		recipe.addRecipe(new ObMagiaRecipes(
			new ItemStack(ItemInit.magic_deadly_poison),
			new ItemStack[] { new ItemStack(ItemInit.cosmic_crystal_shard, 4), new ItemStack(ItemInit.poison_bottle, 64), new ItemStack(ItemInit.mystical_page, 4) },
			new ItemStack[] { new ItemStack(ItemInit.magic_endpoison) }
		));
		...
		recipe.addRecipe(new ObMagiaRecipes(
			...
			new ItemStack[] { new ItemStack(ItemInit.pure_crystal), new ItemStack(Items.GHAST_TEAR, 8), new ItemStack(ItemInit.mystical_page) },
			new ItemStack[] { new ItemStack(ItemInit.magic_refresh_gift) }
		));

		// 魔法陣デバフ解除魔法
		recipe.addRecipe(new ObMagiaRecipes(
			new ItemStack(ItemInit.magic_refresh_gift),
			new ItemStack[] { new ItemStack(ItemInit.cosmic_crystal_shard, 4), new ItemStack(Items.GHAST_TEAR, 4), new ItemStack(ItemInit.mystical_page, 4), new ItemStack(ItemInit.magic_regene) },
			new ItemStack[] { new ItemStack(ItemInit.magic_reflesh_field) }
		));
		...
		// 作物広範囲育成魔法
		recipe.addRecipe(new ObMagiaRecipes(
			new ItemStack(ItemInit.magic_growth_verre),
			new Object[] { new ItemStack(ItemInit.cosmic_crystal_shard, 4), new ItemStack(ItemInit.sugarbell, 64), new ItemStack(ItemInit.mystical_page, 4)
					, "magicBookCosmic" },
			new ItemStack[] { new ItemStack(ItemInit.magic_growth_collect) }
		));
		...
		if (!SMConfig.spawn_mob) {
			...
			recipe.addRecipe(new ObMagiaRecipes(
				...
				new ItemStack[] { new ItemStack(ItemInit.aether_crystal, 16), new ItemStack(ItemInit.divine_crystal, 6), new ItemStack(ItemInit.pure_crystal, 2) },
				new ItemStack[] { new ItemStack(BlockInit.sturdust_crystal_bot) }
			));
		}
	}
}
