	...
	public void registerAlstroemeriaRecipe(AlstroemeriaRecipes recipe) {
		...
		if (SMConfig.addVanilaRecipe) {
			...
			recipe.addRecipe(new AlstroemeriaRecipes(
				new ItemStack(BlockInit.glow_light, 4),
				new Object[] { new ItemStack(ItemInit.fire_powder, 4), new ItemStack(ItemInit.magicmeal, 4) },
				new ItemStack[] { new ItemStack(Blocks.SPONGE) }
			));
			...
			recipe.addRecipe(new AlstroemeriaRecipes(
				...
				new ItemStack[] { new ItemStack(Items.CHORUS_FRUIT, 4) }
			));

			// エンドストーン
			recipe.addRecipe(new AlstroemeriaRecipes(
				new OreItems("stone", 4),
				new Object[] { new ItemStack(ItemInit.ender_shard), new ItemStack(Items.CHORUS_FRUIT) },
				new ItemStack[] { new ItemStack(Blocks.END_STONE, 4) }
			));

			// エンドポータル
			recipe.addRecipe(new AlstroemeriaRecipes(
				new ItemStack(Blocks.END_STONE, 4),
				new Object[] { new ItemStack(Items.ENDER_PEARL, 2), new ItemStack(Items.IRON_INGOT) },
				new ItemStack[] { new ItemStack(Blocks.END_PORTAL_FRAME) }
			));

			// エンダーパール
			recipe.addRecipe(new AlstroemeriaRecipes(
				new ItemStack(Blocks.GRASS, 4),
				new Object[] { new ItemStack(Items.REDSTONE, 4), new ItemStack(Items.GLOWSTONE_DUST, 4) },
			...
			recipe.addRecipe(new AlstroemeriaRecipes(
				...
				new ItemStack[] { new ItemStack(Items.BRICK, 64) }
			));

			// ネザーレンガ
			recipe.addRecipe(new AlstroemeriaRecipes(
				new ItemStack(Blocks.NETHERRACK, 64),
				new Object[] { new ItemStack(ItemInit.fire_powder) },
				new ItemStack[] { new ItemStack(Items.NETHERBRICK, 64) }
			));

			// テラコッタ
			recipe.addRecipe(new AlstroemeriaRecipes(
				new ItemStack(Blocks.CLAY, 64),
				new Object[] { new ItemStack(ItemInit.fire_powder) },
				new ItemStack[] { new ItemStack(Blocks.HARDENED_CLAY, 64) }
			));
			...
			recipe.addRecipe(new AlstroemeriaRecipes(
				...
				new Object[] { new ItemStack(ItemInit.fire_powder) },
				new ItemStack[] { new ItemStack(Blocks.GLASS, 64) }
			));
			...
			recipe.addRecipe(new AlstroemeriaRecipes(
				...
				new Object[] { new OreItems("dyeRed") },
				new ItemStack[] { new ItemStack(Blocks.RED_NETHER_BRICK, 32) }
			));
		...
		// マギアボトル→マギアフラックスブロック変換
		recipe.addRecipe(new AlstroemeriaRecipes(
			new ItemStack(ItemInit.mf_magiabottle),
			new Object[] { new ItemStack(ItemInit.mf_magiabottle, 9) },
			new ItemStack[] { new ItemStack(BlockInit.magiaflux_block) }
		));

		// マギアフラックス・コア
		recipe.addRecipe(new AlstroemeriaRecipes(
				new ItemStack(ItemInit.pure_crystal, 2),
			new Object[] { new ItemStack(ItemInit.mf_magiabottle, 4), new OreItems("blockGlass", 6) },
			new ItemStack[] { new ItemStack(BlockInit.magiaflux_core) }
		));
		...
		recipe.addRecipe(new AlstroemeriaRecipes(
			...
			new Object[] { new ItemStack(Items.FLINT, 4), new OreItems("gemQuartz", 4), new OreItems("netherrack", 16) },
			new ItemStack[] { new ItemStack(ItemInit.fire_nasturtium_seed, 4) }
		));
		...
		recipe.addRecipe(new AlstroemeriaRecipes(
			...
			new ItemStack[] { new ItemStack(ItemInit.dm_seed, 2) }
		));
		...
		// エーテルカバー
		recipe.addRecipe(new AlstroemeriaRecipes(
			new ItemStack(BlockInit.prismglass, 16),
			new Object[] { new OreItems("dustSugar") },
			new ItemStack[] { new ItemStack(BlockInit.aether_cover, 32) }
		));

		// エーテルカバー
		recipe.addRecipe(new AlstroemeriaRecipes(
			new ItemStack(BlockInit.aether_cover, 4),
			new Object[] { new OreItems("dustSugar") },
			new ItemStack[] { new ItemStack(BlockInit.aether_cover_rock, 8) }
		));
		...
		// 花袋
		recipe.addRecipe(new AlstroemeriaRecipes(
			new OreItems("listAllflower", 5),
			new Object[] { new ItemStack(Items.STRING), new ItemStack(ItemInit.cotton_cloth, 4) },
			new ItemStack[] { new ItemStack(ItemInit.flowerpack) }
		));
		...
		recipe.addRecipe(new AlstroemeriaRecipes(
			...
			new Object[] { "treeSapling" },
			new ItemStack[] { new ItemStack(BlockInit.magiawood_sapling) }
		));
		...
		// パステルタイルレンガ
		Map<Block, String> pastelRecipe = new HashMap<>();
		pastelRecipe.put(BlockInit.pasteltile_brick_r, "dyeRed");
		pastelRecipe.put(BlockInit.pasteltile_brick_b, "dyeBlue");
		pastelRecipe.put(BlockInit.pasteltile_brick_y, "dyeYellow");
		pastelRecipe.put(BlockInit.pasteltile_brick_lg, "dyeGreen");
		pastelRecipe.put(BlockInit.pasteltile_brick_br, "dyeBrown");
		pastelRecipe.put(BlockInit.pasteltile_brick_bl, "dyeBlack");
		pastelRecipe.put(BlockInit.pasteltile_brick_gr, "dyeGray");

		for (Entry<Block, String> map : pastelRecipe.entrySet()) {

			// パステルタイルレンガ
			recipe.addRecipe(new AlstroemeriaRecipes(
				new ItemStack(Blocks.NETHER_BRICK, 8),
				new Object[] { new ItemStack(Blocks.BRICK_BLOCK, 8), map.getValue() },
				new ItemStack[] { new ItemStack(map.getKey(), 32) }
			));
		}
