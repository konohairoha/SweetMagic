...
public class FlourMillRecipePlugin implements IFlourMillRecipePlugin {
	...
	public void registerFlourMillRecipe(FlourMillRecipes recipe) {
		...
		recipe.addRecipe(new FlourMillRecipes(
			...
			new ItemStack[] { new ItemStack(Blocks.DIRT), new ItemStack (Blocks.GRAVEL)
		}));
		...
		recipe.addRecipe(new FlourMillRecipes(
			...
			new ItemStack[] { new ItemStack(Blocks.DOUBLE_PLANT, 1, 2), new ItemStack(Blocks.SAPLING, 1, 4)
		}));

		// 大きなシダ
		recipe.addRecipe(new FlourMillRecipes(
			new ItemStack(Blocks.LEAVES, 1, 3),
			new ItemStack[] { new ItemStack(Blocks.DOUBLE_PLANT, 1, 3), new ItemStack(Blocks.SAPLING, 1, 5)
		}));
