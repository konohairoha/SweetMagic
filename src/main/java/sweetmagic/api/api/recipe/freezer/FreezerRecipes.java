...
public class FreezerRecipes {
    ...
    public FreezerRecipes(Object hand , Object[] inputs ,Object[] outputs) {
        this.clear();
    ...
    //レシピ登録
    public static void addRecipe(FreezerRecipes recipes) {
    	SweetMagicAPI.freezRecipe.add(recipes);
    }
}
