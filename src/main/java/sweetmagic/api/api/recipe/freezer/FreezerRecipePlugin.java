...
public class FreezerRecipePlugin implements IFreezerRecipePlugin {
	...
	public void registerFreezerRecipe(FreezerRecipes recipe) {
		...
		recipe.addRecipe(new FreezerRecipes(
			...
			new Object[] { new ItemStack(Blocks.ICE), "dustSugar", new OreItems("foodGelatine", 2), "bucketWater" },
		...
		recipe.addRecipe(new FreezerRecipes(
			...
			new Object[] { "foodChocolatebar", "foodButter", "dustSalt", "egg", "bucketWater", "dustSugar" },
		...
		recipe.addRecipe(new FreezerRecipes(
			...
			new Object[] { "egg", new OreItems("foodVanilla", 2), "bucketWater", "dustSugar" },
		...
		recipe.addRecipe(new FreezerRecipes(
			...
			new Object[] { "foodDough", new OreItems("foodVanilla", 2), new OreItems("foodCream", 2), new OreItems("dustSugar", 2) },
			new ItemStack[] { new ItemStack(ItemInit.short_cake, 5) }
		));

		// フルーツポンチ
		recipe.addRecipe(new FreezerRecipes(
			new OreItems("cropBanana", 2),
			new Object[] { "listAllfruit", "foodVanilla", "dustSugar", "bucketWater" },
		...
		recipe.addRecipe(new FreezerRecipes(
			...
			new Object[] { new OreItems("cropCorn", 2), "cropCarrot", "foodSaladdressing" },
		...
		recipe.addRecipe(new FreezerRecipes(
			...
			new Object[] { new OreItems("cropCorn", 2), "cropCarrot", "dustSalt", "foodSaladdressing" },
		...
		recipe.addRecipe(new FreezerRecipes(
			...
			new Object[] { new OreItems("cropCarrot", 2), "dustSalt", new OreItems("foodMayo", 3), "foodVinegar" },
		...
		recipe.addRecipe(new FreezerRecipes(
			...
			new Object[] { new OreItems("foodRice", 6), new OreItems("foodVinegar", 3), new ItemStack(ItemInit.dry_seaweed, 6) },
		...
		recipe.addRecipe(new FreezerRecipes(
			...
			new Object[] { new OreItems("foodRice", 4), new OreItems("foodVinegar", 3), new OreItems("dustSalt", 2), new OreItems("dustSugar", 2) },
		...
		recipe.addRecipe(new FreezerRecipes(
			...
			new Object[] { new OreItems("foodRice", 4), new OreItems("foodVinegar", 3), new OreItems("dustSalt", 2), new OreItems("dustSugar", 2), new ItemStack(ItemInit.dry_seaweed, 2) },
		...
		// オレンジタルト
		recipe.addRecipe(new FreezerRecipes(
			new OreItems("cropOrange", 8),
			new Object[] { new OreItems("egg", 4), new OreItems("foodCream", 2), new OreItems("foodCustard", 3), new ItemStack(ItemInit.vannila_essence, 2), "foodLiquor", new OreItems("dustSugar", 2) },
			new ItemStack[] { new ItemStack(ItemInit.orange_tart, 8) }
		));
		...
		recipe.addRecipe(new FreezerRecipes(
			new OreItems("cropLettuce", 3),
			new Object[] { new OreItems("listAllveggie", 3), new OreItems("bread", 3), new OreItems("foodMayo", 3), new OreItems("foodButter", 2) },
		...
		recipe.addRecipe(new FreezerRecipes(
			...
			new Object[] { new OreItems("foodCream", 4), new OreItems("foodVanilla", 4), "dustSalt", "foodGelatine" },
		...
		recipe.addRecipe(new FreezerRecipes(
			new OreItems("bucketMilk", 4),
			new Object[] { new OreItems("foodCream", 4), new OreItems("foodChocolatebar", 2), "dustSalt", "foodGelatine" },
		...
		recipe.addRecipe(new FreezerRecipes(
			...
			new Object[] { new OreItems("cropOnion", 4), new OreItems("foodOil", 4), "cropLemon", "dustSalt", new OreItems("bucketWater", 2) },
		...
		recipe.addRecipe(new FreezerRecipes(
			...
			new Object[] { new OreItems("cropApple", 2), new OreItems("cropLettuce", 4), "foodCheese", new OreItems("foodSaladdressing", 3) },
		...
		// シーザーサラダ
		recipe.addRecipe(new FreezerRecipes(
			new OreItems("cropTomato", 2),
			new Object[] { new OreItems("cropLettuce", 4), "foodBread", "egg", new OreItems("foodCheese", 2), "foodOil", new OreItems("foodSaladdressing", 2) },
			new ItemStack[] { new ItemStack(ItemInit.salad_caesar, 6) }
		));
	}
}
