...
public class FreezerRecipeInfo extends NormalRecipeInfo {
	...
	// アイテム情報セット用初期化
	public FreezerRecipeInfo(List<ItemStack> hand, List<Object[]> input, List<Object> outs) {
		this.handList = hand;
	...
	public FreezerRecipeInfo setRecipeInfo(List<ItemStack> hand, List<Object[]> input, List<Object> outputs) {
		this.handList = hand;
		this.inputItems = input;
