...
public class FermenterRecipes {
	...
	public FermenterRecipes() {
        this.clear();
    }

    public FermenterRecipes(Object hand , Object[] inputs ,Object[] outputs) {
        this.clear();
    ...
    //レシピ登録
    public static void addRecipe(FermenterRecipes recipes) {
    	SweetMagicAPI.fermenterRecipe.add(recipes);
    }
}
