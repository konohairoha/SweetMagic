...
public class ContainerMFSuccessor extends Container {

	final TileMFSuccessor tile;
	...
	void initSlots(InventoryPlayer invPlayer) {
		...
		// オリジナル
		for (int i = 0; i < 2; i++)
			this.addSlotToContainer(new ValidatedSlot(this.tile.getWand(), i, 46 + 65 * i, 30, SlotPredicates.SMWAND));

		// 継承先
//		this.addSlotToContainer(new ValidatedSlot(this.tile.getWand(), 1, 39, 39, SlotPredicates.SMWAND));
