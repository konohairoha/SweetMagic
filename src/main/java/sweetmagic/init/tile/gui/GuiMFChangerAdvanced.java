...
public class GuiMFChangerAdvanced extends GuiContainer {

	private static final ResourceLocation TEX = new ResourceLocation("sweetmagic", "textures/gui/gui_mfchanger_advanced.png");
	private final TileMFChangerAdvanced tile;

	public GuiMFChangerAdvanced(InventoryPlayer invPlayer, TileMFChangerAdvanced tile) {
		super(new ContainerMFChangerAdvanced(invPlayer, tile));
		this.xSize = 176;
		this.ySize = 152;
		this.tile = tile;
	}
