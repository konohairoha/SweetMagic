...
public class RenderZombieKronos extends RenderLiving<EntityZombieKronos> {
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityZombieKronos entity) {
		return TEXTURES;
	}
	...
	public boolean shouldRender(EntityZombieKronos liv, ICamera camera, double camX, double camY, double camZ) {
	...
	public boolean shouldRender(EntityZombieKronos liv, EntityLivingBase entity, ICamera camera, double camX, double camY, double camZ) {
	...
	public void doRender(EntityZombieKronos liv, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	public void doRender(EntityZombieKronos liv, EntityLivingBase entity, double x, double y, double z, float entityYaw, float partialTicks) {
		float f = /*liv.getAttackAnimationScale(partialTicks)*/ 1F;
