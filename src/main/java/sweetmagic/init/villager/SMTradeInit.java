...
public class SMTradeInit {
	...
	public static void init() {
		...
		COOK0.add(new SMTradeInit(TradeType.BUY, new ItemStack(Items.EGG, 16), 0));
		...
		for (int i = 0; i < 13; i++) {
			...
			MAGIC3.add(new SMTradeInit(TradeType.BUY, TradeList.getMagicItem(), 1));
			MAGIC4.add(new SMTradeInit(TradeType.BUY, TradeList.getMagicDrop(), 0));
			MAGIC4.add(new SMTradeInit(TradeType.BUY, TradeList.getMagicDrop(), 1));
		}
	}
}
