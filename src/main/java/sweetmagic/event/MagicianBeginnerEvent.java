...
public class MagicianBeginnerEvent {
	...
	private final static String FACING = "facing";
	private final static String SNEAK = "sneak";
	private final static String X = "posX";
	private final static String Y = "posY";
	private final static String Z = "posZ";
