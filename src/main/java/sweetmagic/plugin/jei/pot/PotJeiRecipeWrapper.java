...
public class PotJeiRecipeWrapper implements IRecipeWrapper {
	...
	public PotJeiRecipeWrapper(PotRecipes recipe) {
	...
	public void drawInfo(Minecraft minecraft, int recipeWidth, int recipeHeight, int mouseX, int mouseY) {
		...
		minecraft.fontRenderer.drawString("cooktime : 5sec", 58, 40, 0xFFFFFF, true);
