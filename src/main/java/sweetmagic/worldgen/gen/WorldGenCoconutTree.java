...
public class WorldGenCoconutTree extends WorldGenAbstractTree {
    ...
    public void genCoconut (World world, Random rand, BlockPos pos, IBlockState smLeave, IBlockState AIR) {
		...
		for (int z = -4; z <= 4; z++) {
			this.setBlock(world, pos.add(0, 9, z), smLeave);
		}
		...
		for (int z = -1; z <= 1; z++) {
			this.setBlock(world, pos.add(0, 6, z), this.plante);
			this.setBlock(world, pos.add(0, 7, z), smLeave);
			this.setBlock(world, pos.add(0, 10, z), smLeave);
		}
    ...
    public void genBanana (World world, Random rand, BlockPos pos, IBlockState smLeave, IBlockState AIR) {
    	...
    	for (int z = -2; z <= 2; z++) {
			this.setBlock(world, pos.add(0, 4, z), smLeave);
    	}
