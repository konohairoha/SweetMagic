...
public class BlockCeilingLight extends BaseModelBlock {
	...
	public static final AxisAlignedBB PILLAR_AABB = new AxisAlignedBB(0.375D, 0.9375D, 0.375D, 0.625D, 1D, 0.625D);
    public static final AxisAlignedBB SOUTH_AABB = new AxisAlignedBB(0.375D, 0.9375D, 0.625D, 0.625D, 1D, 1D);
    public static final AxisAlignedBB WEST_AABB = new AxisAlignedBB(0D, 0.9375D, 0.375D, 0.375D, 1D, 0.625D);
    public static final AxisAlignedBB NORTH_AABB = new AxisAlignedBB(0.375D, 0.9375D, 0D, 0.625D, 1D, 0.375D);
    public static final AxisAlignedBB EAST_AABB = new AxisAlignedBB(0.625D, 0.9375D, 0.375D, 1D, 1D, 0.625D);

    protected static final AxisAlignedBB[] AABB = new AxisAlignedBB[] {
    	new AxisAlignedBB(0.375D, 0.9375D, 0.375D, 0.625D, 1D, 0.625D),
		new AxisAlignedBB(0.375D, 0.9375D, 0.375D, 0.625D, 1D, 1D),
		new AxisAlignedBB(0D, 0.9375D, 0.375D, 0.625D, 1D, 0.625D),
		new AxisAlignedBB(0D, 0.9375D, 0.375D, 0.625D, 1D, 1D),
		new AxisAlignedBB(0.375D, 0.9375D, 0D, 0.625D, 1D, 0.625D),
		new AxisAlignedBB(0.375D, 0.9375D, 0D, 0.625D, 1D, 1D),
		new AxisAlignedBB(0D, 0.9375D, 0D, 0.625D, 1D, 0.625D),
		new AxisAlignedBB(0D, 0.9375D, 0D, 0.625D, 1D, 1D),
		new AxisAlignedBB(0.375D, 0.9375D, 0.375D, 1D, 1D, 0.625D),
		new AxisAlignedBB(0.375D, 0.9375D, 0.375D, 1D, 1D, 1D),
		new AxisAlignedBB(0D, 0.9375D, 0.375D, 1D, 1D, 0.625D),
		new AxisAlignedBB(0D, 0.9375D, 0.375D, 1D, 1D, 1D),
		new AxisAlignedBB(0.375D, 0.9375D, 0D, 1D, 1D, 0.625D),
		new AxisAlignedBB(0.375D, 0.9375D, 0D, 1D, 1D, 1D),
		new AxisAlignedBB(0D, 0.9375D, 0D, 1D, 1D, 0.625D),
