...
public class InventoryFarmClothes implements IItemHandlerModifiable {

	public final IItemHandlerModifiable inventory;
	public final ItemStack invItem;

	public InventoryFarmClothes(EntityPlayer player) {
		this.invItem = player.getItemStackFromSlot(EntityEquipmentSlot.CHEST);
		this.inventory = new ItemStackHandler(150);
