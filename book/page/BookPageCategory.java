	...
	public class EntryLinkButton extends GuiButton {
		...
		public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks) {
			...
			if (flag) {
				...
				Gui.drawRect(this.x - 3, this.y, this.x + rectWidth + 6, this.y + this.height + 2, 0x40000000);
			}
			...
			if (this.entry != null && !this.entry.getIcon().isEmpty()) {
				...
				mc.getRenderItem().renderItemIntoGUI(this.entry.getIcon(), (int) ((this.x) / scale), (int) (this.y / scale) + 1);
