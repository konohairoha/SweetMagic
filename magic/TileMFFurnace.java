...
public class TileMFFurnace extends TileMFBase {
	...
	public final ItemStackHandler inputInv = new InventoryWoodChest(this, this.getInvSize());
...
//			this.changeBlock();
	...
	public void smeltItem () {
		...
		// しゅみゅレーションしてだめなら終了
		ItemStack resultStack = ItemHandlerHelper.insertItemStacked(this.outInv, smeltStack, true);
		if (!resultStack.isEmpty()) { return; }

		resultStack = ItemHandlerHelper.insertItemStacked(this.outInv, smeltStack, false);
