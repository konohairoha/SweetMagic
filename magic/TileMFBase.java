...
public class TileMFBase extends TileSMBase implements IMFBlock {
	...
	private final int dayTime = 24000;
	...
	private boolean findBasePlayer = false;
	...
	public void clientUpdate() {
		...
		if (this.getTime() % 80 == 0 && !this.posList.isEmpty() && this.canMFChange()) {
			...
			this.checkBaseRangePlayer();
			if (!this.findBasePlayer) { return; }
	...
	private void checkBaseRangePlayer () {
		if (!this.isSever()) {
			this.findBasePlayer = this.findRangePlayer(64D, 32D, 64D);
		}
	}
	...
	public NBTTagCompound writeNBT(NBTTagCompound tags) {
		...
		tags.setBoolean("findBasePlayer", this.findBasePlayer);
		return tags;
	}
	...
	public void readNBT(NBTTagCompound tags) {
		...
		this.findBasePlayer = tags.getBoolean("findBasePlayer");
	}
	...
	public EnumFacing getFace () {
		...
		if ( !(state.getBlock() instanceof BaseMFFace)) { return EnumFacing.NORTH; }

		return state.getValue(BaseMFFace.FACING);
	}
}
