...
public class TileMFForer extends TileMFFisher {

	public int needMF = 800;
	...
	public boolean onFishing () {
		...
		if (this.isSever()) {
			...
			ItemStack stack = meat.get(rand.nextInt(meat.size()));
		...
		this.playSound(this.pos, SoundEvents.ENTITY_SHEEP_SHEAR, 0.25F, 1F);
