...
public class TileMFChanger extends TileMFBase {
	...
	// MFアイテムのスロット
	public final ItemStackHandler inputInventory = new InventoryWoodChest(this, this.getInvSize()) {
	...
	private final IItemHandlerModifiable output = new WrappedItemHandler(this.inputInventory, WrappedItemHandler.WriteMode.IN);
