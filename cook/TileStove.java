...
public class TileStove extends TileSMBase {
	...
	private final int needBurnTime = 100;		// 必要燃焼時間
	private int burnTime = 0;					// 燃焼時間
	private final int maxBurnTime = 100000;	// 最大燃焼時間
	...
	private final IItemHandlerModifiable output = new WrappedItemHandler(this.fuelInv, WrappedItemHandler.WriteMode.IN);
