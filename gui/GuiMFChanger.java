...
public class GuiMFChanger extends GuiContainer {
	...
	private static final ResourceLocation TEX = new ResourceLocation(SweetMagicCore.MODID, "textures/gui/gui_mfchanger_tier1.png");
	...
	protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) {
		...
		if (this.tile.getInvSize() >= 5) {
			this.drawTexturedModalRect(x + 43, y + 26, 0, 178, 90, 18);
		}
