...
public class GuiMFTable extends GuiContainer {
	...
	protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) {
		...
		Minecraft.getMinecraft().renderEngine.bindTexture(TEX_TIER1);
	...
	public void renderSlot (int x, int y) {
		...
		this.drawTexturedModalRect(x + 37, y + 84, 236, 66, 18, 22);
		this.drawTexturedModalRect(x + 14, y + 22, 236, 66, 18, 22);
		this.drawTexturedModalRect(x + 61, y + 22, 236, 66, 18, 22);
		if (size < 6) { return; }

		this.drawTexturedModalRect(x + 1, y + 59, 236, 66, 18, 22);
		this.drawTexturedModalRect(x + 73, y + 59, 236, 66, 18, 22);
	}
