...
public class GuiShoeBox extends GuiContainer implements IChestButtonCallback {
	...
	public GuiShoeBox(InventoryPlayer invPlayer, TileWoodChest tile) {
		super(new ContainerShoeBox(invPlayer, tile));
		this.xSize = 176;
		this.ySize = 166;
		this.tile = tile;
	}
