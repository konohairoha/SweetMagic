...
public class GuiWorkbenchStorage extends GuiContainer implements IChestButtonCallback {
	...
	private final TileWorkbenchStorage tile;

	public GuiWorkbenchStorage(InventoryPlayer invPlayer, TileWorkbenchStorage tile) {
		super(new ContainerWorkbenchStorage(invPlayer, tile));
		this.xSize = 175;
		this.ySize = 229;
		this.tile = tile;
	}
