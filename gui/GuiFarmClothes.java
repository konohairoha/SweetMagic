...
public class GuiFarmClothes extends GuiContainer implements IChestButtonCallback {

	private final static ResourceLocation TEX = new ResourceLocation(SweetMagicCore.MODID , "textures/gui/swchest.png");

	public GuiFarmClothes(InventoryPlayer invPlayer, InventoryFarmClothes inv) {
		super(new ContainerFarmClothes(invPlayer, inv));
		this.xSize = 255;
		this.ySize = 255;
	}
