...
public class GuiToolRepair extends GuiContainer {

	private static final ResourceLocation texture = new ResourceLocation(SweetMagicCore.MODID, "textures/gui/gui_toolrepair.png");
	private final TileToolRepair tile;

	public GuiToolRepair(InventoryPlayer invPlayer, TileToolRepair tile) {
		super(new ContainerToolRepair(invPlayer, tile));
		this.xSize = 176;
		this.ySize = 178;
		this.tile = tile;
	}
