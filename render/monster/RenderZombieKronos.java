...
import sweetmagic.init.entity.layer.LayerKronos;
...
public class RenderZombieKronos extends RenderLiving<EntityZombieKronos> {
	...
	private static final ResourceLocation TEX = new ResourceLocation(SweetMagicCore.MODID, "textures/entity/kronos.png");
	...
	public RenderZombieKronos(RenderManager render) {
        ...
        this.addLayer(new LayerKronos(this));
	}
